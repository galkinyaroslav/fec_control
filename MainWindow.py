...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.crosstalk_even_btn = QPushButton(self.frame_2)
        self.crosstalk_even_btn.setObjectName(u"crosstalk_even_btn")
        sizePolicy2.setHeightForWidth(self.crosstalk_even_btn.sizePolicy().hasHeightForWidth())
        self.crosstalk_even_btn.setSizePolicy(sizePolicy2)
        self.crosstalk_even_btn.setMinimumSize(QSize(160, 20))

        self.verticalLayout_4.addWidget(self.crosstalk_even_btn)

        self.crosstalk_odd_btn = QPushButton(self.frame_2)
        self.crosstalk_odd_btn.setObjectName(u"crosstalk_odd_btn")
        sizePolicy2.setHeightForWidth(self.crosstalk_odd_btn.sizePolicy().hasHeightForWidth())
        self.crosstalk_odd_btn.setSizePolicy(sizePolicy2)
        self.crosstalk_odd_btn.setMinimumSize(QSize(160, 20))

        self.verticalLayout_4.addWidget(self.crosstalk_odd_btn)

        self.crosstalk_last_run_label = QLabel(self.frame_2)
        self.crosstalk_last_run_label.setObjectName(u"crosstalk_last_run_label")
        sizePolicy.setHeightForWidth(self.crosstalk_last_run_label.sizePolicy().hasHeightForWidth())
        ...
        self.raw_btn = QPushButton(self.frame_3)
        ...
        self.raw_btn.setMinimumSize(QSize(40, 20))

        self.gridLayout_2.addWidget(self.raw_btn, 14, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.adcd_number_label, 12, 0, 1, 2)
        ...
        self.adcd_number_spinBox.setMaximum(31)

        self.gridLayout_2.addWidget(self.adcd_number_spinBox, 12, 2, 1, 1)

        self.raw_lastrun_name_label = QLabel(self.frame_3)
        ...
        self.get_pll_btn = QPushButton(self.frame_3)
        self.get_pll_btn.setObjectName(u"get_pll_btn")
        sizePolicy.setHeightForWidth(self.get_pll_btn.sizePolicy().hasHeightForWidth())
        self.get_pll_btn.setSizePolicy(sizePolicy)
        self.get_pll_btn.setMinimumSize(QSize(40, 20))

        self.gridLayout_2.addWidget(self.get_pll_btn, 9, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.line_8, 10, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.adcd_btn, 11, 0, 1, 2)

        self.raw_lastrun_label = QLabel(self.frame_3)
        ...
        self.raw_lastrun_label.setMinimumSize(QSize(40, 20))

        self.gridLayout_2.addWidget(self.raw_lastrun_label, 14, 2, 1, 1)
        ...
        self.line_7.setMinimumSize(QSize(40, 20))
        ...
        self.gridLayout_3.addWidget(self.frame_3, 0, 0, 4, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.crosstalk_even_btn.setText(QCoreApplication.translate("MainWindow", u"EVEN", None))
        self.crosstalk_odd_btn.setText(QCoreApplication.translate("MainWindow", u"ODD", None))
        self.crosstalk_last_run_label.setText(QCoreApplication.translate("MainWindow", u"last_run", None))
        ...
        self.raw_lastrun_name_label.setText(QCoreApplication.translate("MainWindow", u"./runs/n_card/cdet/test_name/file_name", None))
        ...
        self.tts_tth_btn.setText(QCoreApplication.translate("MainWindow", u"tts 1;tth 1", None))
        ...
        self.get_pll_btn.setText(QCoreApplication.translate("MainWindow", u"Get PLL", None))
        self.adcd_btn.setText(QCoreApplication.translate("MainWindow", u"Get Adcd", None))
        self.raw_lastrun_label.setText(QCoreApplication.translate("MainWindow", u"Last run:", None))
